  ...
  return (
    <section className="space-y-6">
      ...
      <div className="flex gap-3">
        <button onClick={copy} className="rounded bg-blue-600 text-white px-3 py-2 text-sm hover:bg-blue-700">Copy</button>
        <button onClick={download} className="rounded border px-3 py-2 text-sm">Download Hello.html</button>
      </div>
